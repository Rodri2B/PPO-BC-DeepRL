...
class PPO_agent(object):
	...
	def load(self,MName):
		self.actor.load_state_dict(torch.load("./model/{}_actor.pth".format(MName), map_location=self.dvc))
		self.critic.load_state_dict(torch.load("./model/{}_q_critic.pth".format(MName), map_location=self.dvc))
